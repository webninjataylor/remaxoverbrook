...
function MM_initTimelines() { //v4.0
    ...
    if (ns5 || macIE5)
        document.MM_Time[0][0].values[1] = new Array("170px", "167px", "163px", "160px", "156px", "153px", "150px", "146px", "143px", "139px", "136px", "133px", "129px", "126px", "122px", "119px", "115px", "112px", "109px", "105px", "102px", "98px", "95px", "92px", "88px", "85px", "81px", "78px", "75px", "71px", "68px", "64px", "61px", "58px", "54px", "51px", "47px", "44px", "40px", "37px", "34px", "30px", "27px", "23px", "20px");
    else
        document.MM_Time[0][0].values[1] = new Array(170,167,163,160,156,153,150,146,143,139,136,133,129,126,122,119,115,112,109,105,102,98,95,92,88,85,81,78,75,71,68,64,61,58,54,51,47,44,40,37,34,30,27,23,20);
...
<div id="content" style="border:12px double #45487E; background-color:#FFFFFF; padding:10px; color:#555555; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; line-height:1.5; width:591px; position:absolute; top:180px; z-index:102; left:23px; visibility: hidden;">
  ...
  <p><strong>Beautiful residential subdivision with great views and <a href="assets/covenants.pdf" target="_blank">protective covenants</a>&mdash;</strong>Overbrook differs from other planned communities, not only because of its beautiful views of the Massanutten and Blue Ridge mountains, but also its lush open green spaces that everyone can enjoy. <strong>39% of Overbrook's Phase 1 is dedicated open space</strong> for you to play in, go for a walk, or just spend time with Mother Nature:</p>
  <ul>
    <li>Numerous common areas for walking and recreation</li>
    <li>Close to schools, shopping, and new hospital</li>
    <li>Public roads maintained by V-DOT</li>
	<li>Public water and sewer</li>
    <li>Home owners association fees (not formed as of this date)<br />
    </li>
  </ul>
  <table width="588" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="196" valign="top" style="padding-left:25px; padding-bottom:5px;"><strong>Contact</strong><br />
Larry Martin<br />
RE/MAX Performance Realty<br />
Toll Free: 1-800-643-2389<br />
Cell: 1-540-820-8212 <br />
<a href="contact.php">Email Us</a></td>
      <td width="196" valign="top" style="padding-left:7px; padding-bottom:5px;"><strong>Plats<br />
      </strong>Phase 2: <a href="images/overbrookPlats_phase2a.gif" target="_blank">Overview</a> <br />
Phase 2: <a href="images/overbrookPlats_phase2b.gif" target="_blank">Lots 10-14</a><br />
Phase 2: <a href="images/overbrookPlats_phase2c.gif" target="_blank">Lots 15-21</a><br />
Phase 2: <a href="images/overbrookPlats_phase2d.gif" target="_blank">Lots 22-24</a><br />
Phase 3: <a href="images/overbrookPlats_phase3a.gif" target="_blank">Lots 25-30</a><br />
Phase 4: <a href="images/overbrookPlats_phase4a.gif" target="_blank">Overview</a><br />
Phase 4: <a href="images/overbrookPlats_phase4b.gif" target="_blank">Lots 31, 32, 49, 50, 57, &amp; 58</a></td>
      <td width="196" align="left" valign="bottom"><a href="#" onclick="document.getElementById('sign').style.visibility='visible'; document.getElementById('content').style.visibility='hidden'; return false;"><img src="images/signTN.jpg" alt="Overbrook Sign" width="177" height="89" border="0" style="margin-bottom:5px; border:1px solid #45487E;" /></a></td>
    </tr>
    <tr>
      <td align="right"><a href="#" onclick="document.getElementById('mountain1').style.visibility='visible'; document.getElementById('content').style.visibility='hidden'; return false;"><img src="images/mountain1TN.jpg" alt="Mountains" width="177" height="89" border="0" style="border:1px solid #45487E;" /></a></td>
      <td align="center"><a href="#" onclick="document.getElementById('mountain2').style.visibility='visible'; document.getElementById('content').style.visibility='hidden'; return false;"><img src="images/mountain2TN.jpg" alt="Mountains" width="177" height="89" border="0" style="border:1px solid #45487E;" /></a></td>
      <td align="left"><a href="#" onclick="document.getElementById('mountain3').style.visibility='visible'; document.getElementById('content').style.visibility='hidden'; return false;"><img src="images/mountain3TN.jpg" alt="Mountains" width="177" height="89" border="0" style="border:1px solid #45487E;" /></a></td>
    </tr>
  </table>
  <div style="text-align:center;"><a href="#" onclick="document.getElementById('mountain1').style.visibility='visible'; document.getElementById('content').style.visibility='hidden'; return false;"></a><a href="#" onclick="document.getElementById('mountain2').style.visibility='visible'; document.getElementById('content').style.visibility='hidden'; return false;"></a><a href="#" onclick="document.getElementById('mountain3').style.visibility='visible'; document.getElementById('content').style.visibility='hidden'; return false;"></a><br />
  <div style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; text-align: center; color:#555555;">&#0169;Copyright 2007 Overbrook. All rights reserved.<br />
  <a href="http://www.tt-graphics.com">Design by T&amp;T Graphics</a></div></div>
</div>
<div id="sign" style="border:12px double #45487E; background-color:#FFFFFF; color:#555555; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; position:absolute; top:180px; z-index:105; left:23px; visibility: hidden;"><a href="#" onclick="document.getElementById('sign').style.visibility='hidden'; document.getElementById('content').style.visibility='visible'; return false;"><img src="images/sign.jpg" width="567" height="257" border="0" /></a>
<p style="padding:10px; margin-top:-5px; margin-bottom:-5px; font-weight:bold; text-align:center;"><a href="#" onclick="document.getElementById('sign').style.visibility='hidden'; document.getElementById('content').style.visibility='visible'; return false;">Close</a>&#160;&#160;&#160;|&#160;&#160;&#160;<a href="javascript:window.print();">Print</a></p></div>
